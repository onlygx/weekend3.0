            ...
            <#list fieldList as field>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div class="input-icon">
                            <i class="fa  fa-qq"></i>
                            <input type="text" class="form-control" required name="${field.name}" value="${field.nameParam}" placeholder="">
                        </div>
                    </div>
                </div>
                </#if>
            ...
            <div class="form-actions">
                <div class="row">
                    <div class="col-md-offset-3 col-md-5">
                        <button type="button" class="btn green" onclick="tools.edit('${lower}');">
